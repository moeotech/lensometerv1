...
pattern = r"fun analyzePoints\(.*?\).*?catch \(e: Exception\) \{\n\s*Log\.e\(\"V4OpticalAnalyzer\", \"AnalyzePoints failed\", e\)\n\s*return V4RunResult\(success = false, errorMessage = \"Exception: \$\{e\.message\}\"\)\n\s*\}\n\s*\}"
